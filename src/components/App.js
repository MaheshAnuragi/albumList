...
export default class App extends Component {
  ...
  render() {
    return (
      <>
        <Routes>
          <Route path='/albumlist' element={<AlbumsList albums={this.state.albums} setUpdateAlbum={this.setUpdateAlbum} deleteAlbumFromList={this.deleteAlbumFromList} />}></Route>
